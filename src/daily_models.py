...
SCALAR_COLUMNS = (
    ...
    "morning_load_range",
    "morning_load_trend",
    "morning_load_level_change",
    "morning_smp_north_mean",
    "morning_smp_south_mean",
    "morning_smp_north_last",
    "morning_smp_south_last",
    "morning_spread_ns_mean",
    "morning_spread_ns_last",
    "prev_full_smp_mean",
    "prev_full_smp_max",
    "prev_full_smp_min",
    "prev_full_gate_prob",
