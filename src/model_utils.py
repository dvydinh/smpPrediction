...
class StackingEnsemble:
    ...
    def get_base_models(self):
        return {
            ...
            'xgb': xgb.XGBRegressor(objective='reg:absoluteerror', learning_rate=0.005, max_depth=8, n_estimators=3000, 
                                    colsample_bytree=0.7, subsample=0.8, random_state=42, tree_method='hist', device='cuda'),
            'cb': CatBoostRegressor(loss_function='MAE', learning_rate=0.01, iterations=3000, depth=7, 
